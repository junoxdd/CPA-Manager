...
export const CycleForm: React.FC<CycleFormProps> = ({ 
  ...
  const parseCurrency = (value: string): number => {
      ...
      if (clean.includes(',') && clean.includes('.')) {
          // Assume formato brasileiro se o último separador for vírgula
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Lucro é calculado matematicamente, sem depender de input manual
    ...
    // Timeout de segurança para destravar o botão se a rede falhar
